...
#ifndef IBDEVREADERFACTORY_H
#define IBDEVREADERFACTORY_H
...
class InfiniBandDevReaderFactory
{
    public:
        InfiniBandDevReaderFactory();
        ~InfiniBandDevReaderFactory();
    ...
    private:
        ...
        static InfiniBandDevReaderFactory m_instance;
};
